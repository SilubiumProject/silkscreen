...
public class CrippledJavaScriptParser {
    ...
    private static boolean isId(char ch) {
        return isDigit(ch) || ch == 95 || ch >= 97 && ch <= 122 || ch >= 65 && ch <= 90;
    }
    ...
    public static Object parseJSExpr(StringParser jsExpr) {
        if(jsExpr.isEmpty()) {
            ...
            } else if(start != 39 && start != 34) {
                if(!isDigit(start) && start != 45 && start != 43) {
                    ...
                    if(start == 110 && jsExpr.peek("ew Date(".length()).equals("ew Date(")) {
                    ...
                    while(true) {
                        ...
                        label139: {
                            if(!jsExpr.isEmpty()) {
                                ...
                                if((sc == 45 || sc == 43) && (psc == 69 || psc == 101)) {
                                    break label139;
                                }
                            }

                            return !dot && !exp?Long.valueOf(Long.parseLong(b.toString())):Double.valueOf(Double.parseDouble(b.toString()));
                        }
